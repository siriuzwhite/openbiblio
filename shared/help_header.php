  ...
  <tr>
    ...
    <td valign="top" bgcolor="<?php echo H(OBIB_ALT1_BG);?>">
      <font  class="alt1">
        ...
        <a href="http://obiblio.sourceforge.net/index.php/Help/<?php echo $_GET["page"]; ;?>" target=_blank><?php echo $loc->getText("Revise Page"); ?></a>
        <font class="error"><font class="small">(<?php echo $loc->getText("wiki updates to this page"); ?>)</font></font><br>
      </font>
    </td>
    <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
